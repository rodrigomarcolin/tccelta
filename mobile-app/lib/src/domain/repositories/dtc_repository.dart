...
///
/// É a *source of truth* dos códigos para a UI: fala Modos 03/07/0A sobre a
/// `BleConnection` viva e lança `DtcReadFailure` em erro. A camada de UI
/// (view_model) nunca toca no transporte de bytes.
//
...
// pública quando a leitura real (Modo 03/07/0A) precisar de mais métodos.
