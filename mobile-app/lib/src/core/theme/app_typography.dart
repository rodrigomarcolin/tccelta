...
abstract final class AppTypography {
  ...
  static TextStyle get displayXl => mono(
    const TextStyle(
      fontSize: 64,
  ...
  static TextStyle get displayL => mono(
    const TextStyle(
      fontSize: 44,
      fontWeight: FontWeight.w700,
      height: 1,
  ...
  static TextStyle get heading => ui(
    const TextStyle(
      fontSize: 26,
      fontWeight: FontWeight.w700,
      height: 1.05,
  ...
  static TextStyle get overline => ui(
    const TextStyle(
      fontSize: 11,
      fontWeight: FontWeight.w600,
      height: 1.3,
