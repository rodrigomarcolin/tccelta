...
% ---
\titulo{Desenvolvendo um Dongle OBD-II com medidas de segurança}
...
\begin{dedicatoria}
   ...
   \centering
   \noindent
   \textit{Perpassa em altivez, pela procela, a grandiloquência condoreira, em cuja máxima aforismática revela a tétrica languidez do sofrer recôndito.} \vspace*{\fill}
\end{dedicatoria}
% ---
...
\textbf{De Davi Félix de Lima} \\
Agradeço...

\vspace{1em}

\textbf{De Rodrigo Sales Marcolin}\\
Agradeço...

\vspace{1em}

\textbf{De Rodrigo Sinato Fernandes}\\
Agradeço...

\vspace{1em}

\textbf{Dos autores} \\
Agradecemos a nossos colegas pelas galhofas e pelos indispensáveis momentos de descontração, que trouxeram leveza e ânimo aos nossos dias; ao Prof. Victor Takashi Hayashi, pela valiosa orientação e pelo apoio neste processo.
...
\begin{epigrafe}
    \vspace*{\fill}
	\begin{flushright}
		\textit{A Máquina era que matava os homens porém \\ os homens é que mandavam na Máquina... \\}
		 \textbf{Mário de Andrade, Macunaíma}
	\end{flushright}
